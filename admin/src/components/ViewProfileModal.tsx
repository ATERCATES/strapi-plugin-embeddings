...
const ViewProfileModal: React.FC<ViewProfileModalProps> = ({ profile, isOpen, onClose }) => {
  ...
  return (
    <Modal.Root open={isOpen} onOpenChange={onClose}>
      <Modal.Content>
        <Modal.Header>
          <Modal.Title>Index Configuration</Modal.Title>
        </Modal.Header>
        ...
        <Modal.Body>
          <Flex direction="column" alignItems="stretch" gap={4}>
            ...
            {profile.fields && profile.fields.length > 0 && (
              <Box>
                ...
                <Flex direction="column" alignItems="stretch" gap={2}>
                  {profile.fields.map((fieldName: string, index: number) => (
                    <Box 
                      key={index} 
            ...
            <Flex gap={4} direction="column">
              <Box>
                <Typography variant="sigma" textColor="neutral600">Created</Typography>
              ...
              <Box>
                <Typography variant="sigma" textColor="neutral600">Updated</Typography>
                <Typography variant="pi">
